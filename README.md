# Unreal Engine 5 OFPA Git Tools
...
modified: Content/__ExternalActors__/Maps/Main/TIK1MZPXWFHY0AJB2J5Y8.uasset
```

**After (using this tool):**
```text
BP_PlayerCharacter
LandscapeProxy_MainWorld
```
...
- Support for Tree, List, and Grid views.
- Context-aware icons for Unreal Engine assets.

## Features (CLI)

- **Zero Dependencies**: Uses standard Python library only.
...
2.  **Index Search**: Finds indices for `ActorLabel` / `FolderLabel` and `StrProperty` in the Name Map.
